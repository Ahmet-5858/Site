const SecretFindDifferentGame = {
    ...
    openChat(container, code) {
        this.render(container, 'chat');
        this.listenForMessages(container, code);
    },

    listenForMessages(container, code) {
        ...
        chatMsgsRef.on('value', (snapshot) => {
            if (this.currentGroup === code) {
                ...
                this.updateChatUI(container, messages);
            }
        });
    },
    ...
    sendMessage(container) {
        ...
        this.db.ref('messages/' + this.currentGroup).push(msg);
        input.value = '';
    },

    updateChatUI(container, messages) {
        ...
        chatMsgs.innerHTML = messages.map(m => `
            <div class="message ${m.sender === currentUsername ? 'own' : ''}">
        ...
        if (view === 'menu') {
            content = `
                <div class="secret-menu">
                    ...
                    <h2>Grup Oyunu</h2>
                    <p>Gerçek zamanlı bir gruba katılın veya yeni bir grup oluşturun.</p>
            ...
            // Initial chat structure, messages will be filled by updateChatUI
            content = `
                <div class="secret-chat-room">
                    ...
                    <div class="chat-messages" id="chat-messages">
                        <div style="text-align:center; opacity:0.5; font-size:0.8rem; margin-top:20px;">Mesajlar yükleniyor...</div>
                    </div>
